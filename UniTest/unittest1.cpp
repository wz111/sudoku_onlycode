...
{		
	...
	public:
		...
		TEST_METHOD(End_Test_ROW123)
		{
			...
			int Real[81] = { 0 };
			memcpy(Real, EP.Row123(arr), sizeof(int) * 81);
			memset(arr, 1, sizeof(int) * 9);
			memset(arr + 9, 2, sizeof(int) * 9);
			memset(arr + 18, 3, sizeof(int) * 9);
			for (int i = 0; i < 9; i++) {
		...
		TEST_METHOD(End_Test_ROW132)
		{
			...
			memset(arr+18, 3, sizeof(int) * 9);
			int Real[81] = { 0 };
			memcpy(Real, EP.Row132(arr), sizeof(int) * 81);
			memset(arr, 1, sizeof(int) * 9);
			memset(arr+9, 2, sizeof(int) * 9);
			memset(arr+18, 3, sizeof(int) * 9);
			for (int i = 0; i < 9; i++) {
		...
		TEST_METHOD(End_Test_ROW456)
		{
			...
			int Real[81] = { 0 };
			memcpy(Real, EP.Row456(arr), sizeof(int) * 81);
			memset(arr + 27, 4, sizeof(int) * 9);
			memset(arr + 36, 5, sizeof(int) * 9);
			memset(arr + 45, 6, sizeof(int) * 9);
			for (int i = 27; i < 36; i++) {
		...
		TEST_METHOD(End_Test_ROW465)
		{
			...
			memset(arr + 45, 6, sizeof(int) * 9);
			int Real[81] = { 0 };
			memcpy(Real, EP.Row465(arr), sizeof(int) * 81);
			memset(arr + 27, 4, sizeof(int) * 9);
			memset(arr + 36, 5, sizeof(int) * 9);
			memset(arr + 45, 6, sizeof(int) * 9);
			for (int i = 27; i < 36; i++) {
		...
		TEST_METHOD(End_Test_ROW546)
		{
			...
			memset(arr + 45, 6, sizeof(int) * 9);
			int Real[81] = { 0 };
			memcpy(Real, EP.Row546(arr), sizeof(int) * 81);
			memset(arr + 27, 4, sizeof(int) * 9);
			memset(arr + 36, 5, sizeof(int) * 9);
			memset(arr + 45, 6, sizeof(int) * 9);
			for (int i = 27; i < 36; i++) {
		...
		TEST_METHOD(End_Test_ROW564)
		{
			...
			memset(arr + 45, 6, sizeof(int) * 9);
			int Real[81] = { 0 };
			memcpy(Real, EP.Row564(arr), sizeof(int) * 81);
			memset(arr + 27, 4, sizeof(int) * 9);
			memset(arr + 36, 5, sizeof(int) * 9);
			memset(arr + 45, 6, sizeof(int) * 9);
			for (int i = 27; i < 36; i++) {
		...
		TEST_METHOD(End_Test_ROW645)
		{
			...
			memset(arr + 45, 6, sizeof(int) * 9);
			int Real[81] = { 0 };
			memcpy(Real, EP.Row645(arr), sizeof(int) * 81);
			memset(arr + 27, 4, sizeof(int) * 9);
			memset(arr + 36, 5, sizeof(int) * 9);
			memset(arr + 45, 6, sizeof(int) * 9);
			for (int i = 27; i < 36; i++) {
		...
		TEST_METHOD(End_Test_ROW654)
		{
			...
			memset(arr + 45, 6, sizeof(int) * 9);
			int Real[81] = { 0 };
			memcpy(Real, EP.Row654(arr), sizeof(int) * 81);
			memset(arr + 27, 4, sizeof(int) * 9);
			memset(arr + 36, 5, sizeof(int) * 9);
			memset(arr + 45, 6, sizeof(int) * 9);
			for (int i = 27; i < 36; i++) {
		...
		TEST_METHOD(End_Test_ROW789)
		{
			...
			int Real[81] = { 0 };
			memcpy(Real, EP.Row789(arr), sizeof(int) * 81);
			memset(arr + 54, 7, sizeof(int) * 9);
			memset(arr + 63, 8, sizeof(int) * 9);
			memset(arr + 72, 9, sizeof(int) * 9);
			for (int i = 54; i < 63; i++) {
		...
		TEST_METHOD(End_Test_ROW798)
		{
			...
			memset(arr + 72, 9, sizeof(int) * 9);
			int Real[81] = { 0 };
			memcpy(Real, EP.Row798(arr), sizeof(int) * 81);
			memset(arr + 54, 7, sizeof(int) * 9);
			memset(arr + 63, 8, sizeof(int) * 9);
			memset(arr + 72, 9, sizeof(int) * 9);
			for (int i = 54; i < 63; i++) {
		...
		TEST_METHOD(End_Test_ROW879)
		{
			...
			memset(arr + 72, 9, sizeof(int) * 9);
			int Real[81] = { 0 };
			memcpy(Real, EP.Row879(arr), sizeof(int) * 81);
			memset(arr + 54, 7, sizeof(int) * 9);
			memset(arr + 63, 8, sizeof(int) * 9);
			memset(arr + 72, 9, sizeof(int) * 9);
			for (int i = 54; i < 63; i++) {
		...
		TEST_METHOD(End_Test_ROW897)
		{
			...
			memset(arr + 72, 9, sizeof(int) * 9);
			int Real[81] = { 0 };
			memcpy(Real, EP.Row897(arr), sizeof(int) * 81);
			memset(arr + 54, 7, sizeof(int) * 9);
			memset(arr + 63, 8, sizeof(int) * 9);
			memset(arr + 72, 9, sizeof(int) * 9);
			for (int i = 54; i < 63; i++) {
		...
		TEST_METHOD(End_Test_ROW978)
		{
			...
			memset(arr + 72, 9, sizeof(int) * 9);
			int Real[81] = { 0 };
			memcpy(Real, EP.Row978(arr), sizeof(int) * 81);
			memset(arr + 54, 7, sizeof(int) * 9);
			memset(arr + 63, 8, sizeof(int) * 9);
			memset(arr + 72, 9, sizeof(int) * 9);
			for (int i = 54; i < 63; i++) {
